...
<?php
    ...
    $query = "SELECT orders.order_id, orders.s_name, branches.branch_city, orders.r_name, orders.r_city, orders.order_date, orders.delivery_date, orders.total_price, orders.status, orders.weight from orders inner join branches on orders.s_city=branches.branch_id";
...
{
  ?>
   <td><a href="manage_order.php?id=<?php echo $row['order_id'];?>" class="action_btn mr_10"><i class='far fa-edit'></i>Manage</a>
<?php
}
