...
<p><a href="form_email.php">Dashboard</a> <i class="fas fa-caret-right"></i> Send Message</p>
</div>
</div>
</div>
</div>
...
<h5 class="modal-title text_white">Send Message/Email</h5>
</div>
...
<button style="background-color: #884ffbe6 ; color:white; padding-top:10px;" class="btn_1 full_width text-center" type="submit" name="send" value="">Send Email</button>
</form>
</div>
</div>
</div>
