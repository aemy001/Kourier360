...
<input type="text" name="search_user" placeholder="Search content here...">
</div>
...
<?php
    ...
    $query = "SELECT users.user_id, users.first_name, users.last_name, users.username, users.email, users.role,branches.branch_name 
    from users inner join branches on users.branch=branches.branch_id ";
    $result = mysqli_query($conn,$query);

  
      $query1 = "SELECT users.user_id, users.first_name, users.last_name, users.username, users.email, users.role,branches.branch_name 
  from users inner join branches on users.branch=branches.branch_id where branch_id <> 111";
