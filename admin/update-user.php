...
<?php
        ...
        if(isset($_POST['update']))
        {
            ...
            $query2 = "UPDATE `users` SET `first_name`='$fname',`last_name`='$lname',`username`='$username',`phone`='$phone',`email`='$email',`password`='$password',`role`='$role' WHERE `user_id` = '$id' ";
...
<input type="text" placeholder="Username" name="username" value="<?php echo $row[3];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<input type="text" placeholder="First Name" name="fname" value="<?php echo $row[1];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<input type="text" placeholder="Last Name" name="lname" value="<?php echo $row[2];?>"> 
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<input type="text" placeholder="Email Address" name="email" value="<?php echo $row[5];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<input type="text" placeholder="Mobile No" name="number" value="<?php echo $row[4];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<input type="password" placeholder="Password" name="password" value="<?php echo $row[6];?>">
</div>
</div>
<div class="col-lg-6">
<select name="role" value="<?php echo $row[7];?>" style="height:47px;line-height:47px;background-color:transparent;border:0;padding:10px 25px;color:#81879f;font-weight:400;font-size:14px;width:100%;display:block;border-radius:10px;border:1px solid #e5ecff">
...
<input type="submit" class="btn_1 radius_btn d-block text-center" value="Update User" name="update">
</div>
</div>
</div>
</div>
