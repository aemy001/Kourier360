                            ...
                            <div class="col-md-6">
                                ...
                                <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">
                                        Connecting people with goods, services and ideas creates opportunities
                                         and improves lives. At 360 Kourier, we believe that a connected country is a better country, and that belief guides everything we do.
                                    </p>
                                    <ul class="feature">
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                ...
                                                <p>Adding speed and quality to your deliveries.</p>                                            
                                            </div>  
                                        </li>
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                ...
                                                <p>Your parcel is the safest with us.</p>                                            
                                            </div>  
                                        </li>
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                ...
                                                <p>On time delivery? No damages? Best rates? We got it all covered.</p>                                            
                                            </div>  
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                <div class="more-about clrbg-before">
                                    ...
                                    <p>We enable our customers to prosper by delivering their products on time in a professional manner. We will continuously challenge ourselves to exceed our customers' expectations by providing leading-edge solutions to their needs.</p>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                                <div class="more-about clrbg-before">
                                    ...
                                    <div class="pad-10"></div>
                                    <p>Kourier 360 values every customer it picks up from and delivers to. Providing a professional and on time service is important to us as well as maintaining both a friendly and professional relationship with our customers.</p>
                                </div>
                            </div>
                            <div class="col-md-4  col-sm-4 wow fadeInUp" data-wow-offset="50" data-wow-delay=".40s">
                                <div class="more-about clrbg-before">
                                    <!-- <h2 class="title-1">our mission</h2> -->
                                    <h2 class="title-1">Why we are best</h2>
                                    <div class="pad-10"></div>
                                    <p>It's all about the service and quality. we outshine by delivering to every nook and corner of Pakistan at very affordable charges through a 100% secure shipment and with the offer of cash on delivery everywhere.</p>
                                </div>
                            </div>
                        </div>
                    </div>
