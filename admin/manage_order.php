...
<?php
   ...
   $Oquery = "SELECT * FROM `orders` WHERE `order_id` = '$id'";

   $Oresult = mysqli_query($conn , $Oquery);

   $row = mysqli_fetch_row($Oresult);
   ...
   if(isset($_POST['confirm']))
   {
    ...
    $Rquery = "UPDATE `orders` INNER JOIN `branches` ON `branch_id`=`s_city` SET `s_name` = '$s_name', `s_city` = '$s_city', `r_name`='$r_name',`r_city`='$r_city',`delivery_date`='$d_date', `weight`='$weight', `total_price`='$price', `status`='$status' WHERE `order_id` = '$id';";
...
<input type="text" placeholder="Sender Name" name="s_name" value="<?php echo $row['2'];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<label for="">Sender City</label>
<input type="text" placeholder="Sender City" name="s_city" value="<?php echo $row['6'];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<label for="">Reciever Name</label>
<input type="text" placeholder="Reciever Name" name="r_name" value="<?php echo $row['7'];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<label for="">Sender City</label>
<input type="text" placeholder="Reciever City" name="r_city" value="<?php echo $row['11'];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<label for="">Delivery Date</label>
<input type="date" placeholder="delivery date" name="delivery_date" value="<?php echo $row['19'];?>">
</div>
</div>
<div class="col-lg-6">
<div class="common_input mb_15">
<label for="">Weight</label>
<input type="number" placeholder="weight" name="weight" value="<?php echo $row['12'];?>">
</div>
</div>
<div class="col-lg-12">
<div class="common_input mb_30">
<label for="">Price</label>
<input type="number" placeholder="price" name="total_price" value="<?php echo $row['18'];?>">
</div>
</div>
<div class="col-lg-12">
<div class="common_input mb_30">
<label for=""> Select Status: </label> <br> <br> 
<select name="status" value="<?php echo $row['20'];?>" id="">
<option value="In Process">In Process</option>
<option value="Canceled">Delivered</option>
<option value="Shipped">Shippment</option>
...
<input type="submit" class="btn_1 radius_btn d-block text-center" value="Confirm Order" name="confirm">
</div>
</table>
    </form>
</div>
...
<p>2022 ©  <a href="#"> <i class="ti-heart"></i> </a><a href="index.php"> Dashboard</a></p>
</div>
</div>
</div>
</div>
