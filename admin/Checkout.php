...
<input type="checkbox" class="form-check-input" id="horizontalCheckbox" data-parsley-multiple="groups" data-parsley-mincheck="2" />
<label class="form-label form-check-label" for="horizontalCheckbox">Confirm Shipping Address</label>
</div>
</div>
</div>
</div>
