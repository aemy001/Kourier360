          ...
          <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
            <div class="page_title_left d-flex align-items-center">
              ...
              <ol class="breadcrumb page_bradcam mb-0">
                ...
                <li class="breadcrumb-item active">Courier Management</li>
              </ol>
            </div>
            <div class="page_title_right">
              ...
              <?php
                ...
                $num_countT = mysqli_num_rows($Tresult);

               if($_SESSION["role"]=="1"){
                 echo "<h2>Total Orders: " . $num_countT . "</h2>" ;
               }
               ?>
              </div>
            </div>
          ...
          <div class="white_card card_height_100 mb_30 user_crm_wrapper">
            ...
            <div class="col-lg-6">
                <div class="single_crm">
                  <div class="crm_head d-flex align-items-center justify-content-between">
                    ...
                    <a href="order_view.php"><i class="fas fa-ellipsis-h f_s_11 white_text"></i></a>
                  </div>
                  <div class="crm_body">
                  <?php
                $query3 = "SELECT * FROM `orders` WHERE `status` = 'In Process'";
            ...
            <div class="col-lg-6">
                <div class="single_crm">
                  ...
                  <div class="crm_body">
                  <?php
                $query4 = "SELECT * FROM `orders` WHERE `status` = 'Delivered'";

                $result4 = mysqli_query($conn,$query4);

                $num_count4 = mysqli_num_rows($result4);

                ?>
                <p>Status Count</p>
                  <h4>Orders Delivered:</h4>
                  <h3><?php echo $num_count4; ?></h3>
              </div>
                  </div>
                </div>
</div>                
            ...
            <div class="col-lg-6">
                <div class="single_crm">
                  ...
                  <div class="crm_body">
                  <?php
                $query5 = "SELECT * FROM `orders` WHERE `status` = 'Shipped'";

                $result5 = mysqli_query($conn,$query5);

                $num_count5 = mysqli_num_rows($result5);

                ?>
                <p>Status Count</p>
                  <h4>Orders Shippment:</h4>
                  <h3><?php echo $num_count5; ?></h3>
                  </div>
                  </div>
                </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="footer_iner text-center">
            <p>2022 © <a href="#"> <i class="ti-heart"></i> </a><a href="index.php">Kourier 360 Dashboard</a></p>
          </div>
        </div>
      </div>
    </div>
